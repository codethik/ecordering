...
<h2>Registration</h2>
    ...
    <div class="input-group">
     ...
     <fieldset>
      <p>By your subscription, you accept all the <a href="../docs/legal.pdf">legal terms of use</a></p>
      <input id="submiter" type="submit" style="margin-top:10px;margin-left:40px;" value="Register">
    </fieldset>
  </form>
</div>
