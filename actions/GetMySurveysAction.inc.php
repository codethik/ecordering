	...
	public function run() {
		...
		if ($this->getSessionLogin()===null) {
			...
			return;
                    ...
                    //return array ->
                    $this->getModel()->setSurveys($this->database->loadSurveysByOwner($this->getSessionLogin()));
                    //For each survey from this array, buil a view :
                   // TODO : Before, build the db function 
                   ;
